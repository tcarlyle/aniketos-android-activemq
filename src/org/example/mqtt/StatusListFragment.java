...
public class StatusListFragment extends ListFragment implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String[] uiBindFrom = { NotificationData.SERVICE_ID, NotificationData.ALERT_TYPE, NotificationData.SERVER_TIME };
	    int[] uiBindTo = { R.id.service, R.id.alert, R.id.timestamp }; // from all_status_row_layout.xml
